...
let listaPeliculas = peliculas.pop()

peliculas.unshift(listaPeliculas.toUpperCase())


console.log (peliculas)

let nuevaspeliculas = ['counter-strike', 'NOP', 'vertigo', 'Nick','avatar']
  
nuevaspeliculas.unshift();
